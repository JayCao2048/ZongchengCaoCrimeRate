...
The data is from [@opendatatoronto], and I used R language [@citeR] to process this paper. Various packages are also used to generate this paper, including tidyverse [@tidyverse], dplyr[@dplyr], ggplot2[@ggplot2].
